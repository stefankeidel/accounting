...
select
    ...
    , case
        ...
        when description ilike 'MILNES BAR%' then 'Expenses:Discretionary'
        when description ilike '%Cotswold Outdoor%' then 'Expenses:Discretionary'
        when description ilike '%Tesco%' then 'Expenses:Mandatory'
        when description ilike 'CASTLE ROCK' then 'Expenses:Discretionary'
        when description ilike '%EDINBURGH TRAMS APP%' then 'Expenses:Transportation'
        when description ilike '%Brewdog%' then 'Expenses:Discretionary'
        when description ilike '%The Co-operative Group%' then 'Expenses:Mandatory'
        when description ilike '%MOXY%' then 'Expenses:Travel'
        when description ilike 'Zettle By PayPal' then 'Expenses:Discretionary'
        when description ilike '%CONTIN VILLAGE STORES%' then 'Expenses:Mandatory'
        when description ilike 'Mountain Warehouse' then 'Expenses:Discretionary'
        when description ilike 'Co-op Food' then 'Expenses:Mandatory'
        when description ilike 'ME Group' then 'Expenses:Discretionary'
        when description ilike '%Old Bridge Inn%' then 'Expenses:Mandatory'
        when description ilike '%HOTEL SQUARE%' then 'Expenses:Travel'
        when description ilike '%ClockHouse Restaurant%' then 'Expenses:Discretionary'
        when description ilike 'BVS RETAIL LTD' then 'Expenses:Discretionary'
        when description ilike 'DEWARSABERFELDY%' then 'Expenses:Discretionary'
        when description ilike '%CO-OPERATIVE GROUP%' then 'Expenses:Mandatory'
        when description ilike '%CO-OP GROUP%' then 'Expenses:Mandatory'
        when description ilike '%Dirty Dicks Bar%' then 'Expenses:Discretionary'
        when description ilike '%Edinburgh Trams%' then 'Expenses:Travel'
        ...
        when description ilike '%Mutterland%' then 'Expenses:Discretionary'
        when description ilike '%Privatbrauerei Schalan%' then 'Expenses:Discretionary'
        when description ilike '%Novum Management GmbH%' then 'Expenses:Travel'
