...
valutadatum_replaced as (
    select
        replace(valutadatum, '30.02.', '29.02.') as valutadatum_replaced
        , *
...
, src_key as (
    select
        *
        , {{ dbt_utils.generate_surrogate_key(['valutadatum_replaced', 'name_zahlungsbeteiligter', 'buchungstext', 'betrag', 'saldo_nach_buchung']) }} as transaction_id
...
-- buchungstext changed between two imports of the same thing. messed up everything, lol
